...
//            dao.createOrUpdate(rocket);
    ...
    public void shouldNotRecreateUser() {
        ...
        JWebUnit.assertTextNotPresent("Welcome back: Jane Doe!");
    }
    ...
    @Test
    public void shouldCreateRocket() {
    	String path = "/";
    	JWebUnit.beginAt(path);
    	JWebUnit.gotoPage("rockets");
    	JWebUnit.assertTextPresent("Rocket Listing Page");
    	JWebUnit.clickLink("Create");
    	JWebUnit.assertTextPresent("Rocket Details Page");
    }
    
    @Test 
    public void shouldSetNewRocket() {
    	String path = "/";
    	JWebUnit.gotoPage("rockets/create");
        //JWebUnit.assertTextPresent("Mission Creation");
        JWebUnit.setTextField("name", "abc@example.com");
        JWebUnit.setTextField("country", "1234");
        JWebUnit.setTextField("time", "Jane");
        JWebUnit.setTextField("description", "Doe");
        JWebUnit.submit();
        JWebUnit.assertTextPresent("What do you want to do today?");
    }
}
